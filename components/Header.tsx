  ...
  return (
    <header style={{ 
      ...
      <nav style={{ display: 'flex', flexWrap: 'wrap', gap: '1.25rem', alignItems: 'center' }}>
        ...
        <Link href="/account" style={{ color: '#ec4899', textDecoration: 'none', fontWeight: 'bold' }}>2.25: Sequential</Link>
        ...
        <Link href="/todos" style={{ color: '#a78bfa', textDecoration: 'none' }}>2.19: Interleave</Link>
      </nav>
